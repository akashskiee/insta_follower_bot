...
edgedriver_path = 'C:/Users/Skyee/Desktop/msedgedriver.exe'
...
# prev_user_list = pd.read_csv('filename.csv', delimiter=',').iloc[:,1:2]
        ...
        for x in range(1,10):
            ...
            if username not in prev_user_list:
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow':
                    ...
                    like_button = webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[2]/section[1]/span[1]/button')
                    like_button.click()
                    likes += 1
                    sleep(randint(18, 25))
                    ...
                    if comm_prob > 7:
                        ...
                        if(comm_prob < 7):
                            comment_box.send_keys('Soo cute 😍😍😍')
                            sleep(1)
                            ...
                            comment_box.send_keys('Awww... So cute 😍😍')
                            sleep(1)
...
updated_user_df.to_csv('{}_users_followes_list.csv'.format(strftime("%Y%m%d-%H%M%S")))
print('Likes {} photos'.format(likes))
